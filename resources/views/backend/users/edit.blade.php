...
@section('content')
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input id="name" name="name" type="text" class="form-control"
                                                placeholder="Enter event name" maxlength="100" required value="{{ $data->name }}"/>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input id="phone_number" name="phone_number" type="text" class="form-control"
                                                placeholder="Enter phone number" maxlength="20" required value="{{ $data->phone_number }}"/>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="address" name="address" type="text" class="form-control"
                                                placeholder="Enter address" maxlength="100" rows="3" required>{{ $data->address }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input id="email" name="email" type="email" class="form-control"
                                                placeholder="Enter email" maxlength="50" required value="{{ $data->email }}"/>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-9 col-form-label">
                                                <div class="checkbox-list">
                                                    <label class="checkbox">
                                                        <input type="checkbox" id="is_active" name="is_active" {{ $data->is_active == 1 ? 'checked' : '' }} />
                                                        <span></span>
                                                    </label>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9 col-form-label">
                                                <div class="checkbox-list">
                                                    <label class="checkbox">
                                                        <input type="checkbox" id="is_verified" name="is_verified" {{ $data->is_verified == 1 ? 'checked' : '' }}/>
                                                        <span></span>
                                                    </label>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group text-center">
                                            <img src="{{ $data->photo_profile ?? asset('assets/backend/media/users/default.jpg') }}" alt="{{ $data->name }}" width="150px">
                                            <input hidden type="text" id="photo_profile_old" name="photo_profile_old" value="{{ $data->photo_profile }}"/>
                                        </div>
                                    </div>
    ...
    <script>
        var userUpdateUrl = "{{ route('user.update', [encrypt($data->id)]) }}";
    </script>
    ...
    <script>
        ...
        function submitUserAxios() {
            const name = document.getElementById('name').value;
            const image = document.getElementById('photo_profile').files[0];
            ...
            // axios.put('/admin/user/' + 1, formData, {
            //     headers: {
            //         'X-CSRF-TOKEN': csrfToken,
            //         'Content-Type': 'multipart/form-data', // Set content type for file uploads
            //     }
