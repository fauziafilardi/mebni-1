...
<html lang="en">
	...
	<head>
		...
		<!--end::Page Scripts-->
        <script src="{{ asset('assets/backend/js/pages/crud/datatables/basic/scrollable.js') }}"></script>
        <script src="{{ asset('assets/backend/js/pages/crud/datatables/basic/basic.js') }}"></script>
        <script src="{{ asset('assets/backend/js/pages/crud/forms/editors/summernote.js') }}"></script>
	</head>
	<!--end::Head-->
	<!--begin::Body-->
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
        ...
        <div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
            <!--begin::Logo-->
            <a href="{{ route('home') }}">
                <img alt="Logo" src="{{ asset('assets/frontend/img/logo/logo_mebni.png') }}" width="50">
            </a>
            <!--end::Logo-->
            <!--begin::Toolbar-->
